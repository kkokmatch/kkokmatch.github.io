/* KokMatch v6.40 early resume guard: must run before legacy listeners. */
(()=>{
'use strict';
...
window.__kokmatchStandalone='6.40';
window.__kokmatchVersionLock='6.40';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.40')}catch{}
...
const BUILD634=Object.freeze({version:'6.40',label:'콕매치 v6.40 · 최신 운영본'});
...
/* KokMatch v6.40: role-safe canonical member paging */
(()=>{
'use strict';
...
try{memberControls=controlsHtml637;window.memberControls=memberControls}catch(e){console.warn('KokMatch v6.40 memberControls source',e)}
...
try{
 ...
 window.renderMembers=renderMembers;
}catch(e){console.warn('KokMatch v6.40 renderMembers wrapper',e)}
try{
...
}catch(e){console.warn('KokMatch v6.40 member pager wrapper',e)}
function arm637(){
...
/* KokMatch v6.40: no-flash member roster resume */
(()=>{
'use strict';
