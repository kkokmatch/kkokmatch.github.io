const KOKMATCH_SW_VERSION='6.61';
const KOKMATCH_CACHE_PREFIX='kokmatch-static-';
const KOKMATCH_STATIC_CACHE=KOKMATCH_CACHE_PREFIX+KOKMATCH_SW_VERSION;
const KOKMATCH_CORE=[
  '/assets/dev-challenger-frame-v661.webp?v=6.61',
  '/app-v6.61.css?v=6.61',
  '/app-v6.61.js?v=6.61',
  '/manifest.webmanifest?v=6.61',
  '/icons/kokmatch-180.png?v=6.61',
...
self.addEventListener('fetch',event=>{
 ...
 const currentAsset=url.pathname===`/app-v${KOKMATCH_SW_VERSION}.js`||url.pathname===`/app-v${KOKMATCH_SW_VERSION}.css`||url.pathname==='/manifest.webmanifest'||url.pathname==='/assets/dev-challenger-frame-v661.webp'||url.pathname.startsWith('/icons/');
