/* KokMatch v6.44 early resume guard: must run before legacy listeners. */
(()=>{
'use strict';
...
window.__kokmatchStandalone='6.44';
window.__kokmatchVersionLock='6.44';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.44')}catch{}
...
function shuttleSvg51(kind){
 ...
 return `<svg viewBox="0 0 24 24" role="img" aria-hidden="true">${defs}
  ...
  <path d="M8.95 16.44 10.25 17.08 22.15 9.2 21.15 6.35Z" fill="${secondary}" stroke="${dark}" stroke-width=".38"/>
...
const CONTAINERS99='.playingPlayer53,.player54,.playerCard,.courtPlayer,.choiceBtn,.pickRow,.candidateRow,.partnerSearchRow82,.partnerPickedCard82,.voteMemberRow,.attendeeRow,.pollMemberRow,.memberVoteRow';
...
const GRADE_BOX12='.playingPlayer53,.player54,.playerCard,.courtPlayer,.choiceBtn,.pickRow,.candidateRow,.partnerSearchRow82,.partnerPickedCard82,.voteMemberRow,.attendeeRow,.pollMemberRow,.memberVoteRow';
...
const BUILD634=Object.freeze({version:'6.44',label:'콕매치 v6.44 · 최신 운영본'});
...
/* KokMatch v6.44: role-safe canonical member paging */
(()=>{
'use strict';
...
try{memberControls=controlsHtml637;window.memberControls=memberControls}catch(e){console.warn('KokMatch v6.44 memberControls source',e)}
...
try{
 ...
 window.renderMembers=renderMembers;
}catch(e){console.warn('KokMatch v6.44 renderMembers wrapper',e)}
try{
...
}catch(e){console.warn('KokMatch v6.44 member pager wrapper',e)}
function arm637(){
...
/* KokMatch v6.44: no-flash member roster resume */
(()=>{
'use strict';
...
/* KokMatch v6.44: preflight + atomic conflict recovery for multi-organizer game creation */
(()=>{
'use strict';
...
/* KokMatch v6.44: unified white cards + grade stripe + faint grade watermark. */
(()=>{
'use strict';
