...
window.__kokmatchStandalone='6.27';
window.__kokmatchVersionLock='6.27';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.27')}catch{}
...
window.selectPollDate623=function(dt){selectedDate623=String(dt);month623=selectedDate623.slice(0,7);renderPoll623();try{window.__kokmatchStatsDateChanged627?.(selectedDate623,month623)}catch{}};
window.movePollMonth623=function(delta){const next=ymShift623(month623,Number(delta)||0);if(next<earliestMonth623())return;month623=next;selectedDate623=next===today623().slice(0,7)?today623():`${next}-01`;renderPoll623();try{window.__kokmatchStatsDateChanged627?.(selectedDate623,month623)}catch{}};
