...
// This stage may receive an already-generated v6.17+ runtime from main. Normalize only generated
// v6.17+ labels back to the v6.17 stage so later v6.18/v6.19/v6.20 generators can run again.
const alreadyCanonical=/__kokmatchBackgroundPollV617='v6\.\d+'/.test(js);
if(alreadyCanonical)js=js.replace(/v6\.(?:1[7-9]|[2-9]\d*)/g,'v6.17');
else js=js.replaceAll('v6.16','v6.17');
...
console.log('v6.17 render stabilization is canonical, repeatable, and normalizes newer generated builds safely.');
