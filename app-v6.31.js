/* v6.31: show the revised iPhone install guide once after upgrade */
...
window.__kokmatchStandalone='6.31';
window.__kokmatchVersionLock='6.31';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.31')}catch{}
...
async function registerSw43(){if(!supported43())return null;if(swReg43)return swReg43;swReg43=await navigator.serviceWorker.register('/kokmatch-sw.js?v=6.31',{scope:'/',updateViaCache:'none'});await navigator.serviceWorker.ready;return swReg43}
...
async function activeSw44(force=false){
 ...
 const initial=await navigator.serviceWorker.register('/kokmatch-sw.js?v=6.31',{scope:'/',updateViaCache:'none'});
...
/* KokMatch v6.31 independent date + compact monthly statistics */
(()=>{
'use strict';
...
/* KokMatch v6.31 PWA install + notification permission guide */
(()=>{
'use strict';
...
/* KokMatch v6.31 first-login session stabilization */
(()=>{
'use strict';
