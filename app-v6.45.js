/* KokMatch v6.45 early resume guard: must run before legacy listeners. */
(()=>{
'use strict';
...
window.__kokmatchStandalone='6.45';
window.__kokmatchVersionLock='6.45';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.45')}catch{}
...
function shuttleSvg51(kind){
 ...
 return `<svg viewBox="0 0 24 24" role="img" aria-hidden="true">${defs}
  ...
  <path d="M8.95 16.45 10.25 17.08 22.15 9.2 21.15 6.35Z" fill="${secondary}" stroke="${dark}" stroke-width=".38"/>
...
const BUILD634=Object.freeze({version:'6.45',label:'콕매치 v6.45 · 최신 운영본'});
...
/* KokMatch v6.45: role-safe canonical member paging */
(()=>{
'use strict';
...
try{memberControls=controlsHtml637;window.memberControls=memberControls}catch(e){console.warn('KokMatch v6.45 memberControls source',e)}
...
try{
 ...
 window.renderMembers=renderMembers;
}catch(e){console.warn('KokMatch v6.45 renderMembers wrapper',e)}
try{
...
}catch(e){console.warn('KokMatch v6.45 member pager wrapper',e)}
function arm637(){
...
/* KokMatch v6.45: no-flash member roster resume */
(()=>{
'use strict';
...
/* KokMatch v6.45: preflight + atomic conflict recovery for multi-organizer game creation */
(()=>{
'use strict';
...
/* KokMatch v6.45: white member/queue cards + right-side queue grade stripe. */
(()=>{
'use strict';
