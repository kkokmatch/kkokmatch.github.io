const KOKMATCH_SW_VERSION='6.73';
const KOKMATCH_CACHE_PREFIX='kokmatch-static-';
const KOKMATCH_STATIC_CACHE=KOKMATCH_CACHE_PREFIX+KOKMATCH_SW_VERSION;
const KOKMATCH_CORE=[
  '/assets/dev-prism-frame-v662.webp?v=6.73',
  '/assets/organizer-silver-aura-v665.webp?v=6.73',
  '/app-v6.73.css?v=6.73',
  '/app-v6.73.js?v=6.73',
  '/manifest.webmanifest?v=6.73',
  '/icons/kokmatch-180.png?v=6.73',
