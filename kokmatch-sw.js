const KOKMATCH_SW_VERSION='6.85';
...
const KOKMATCH_REQUIRED=[
  '/app-v6.85.css?v=6.85',
  '/app-v6.85.js?v=6.85'
];
const KOKMATCH_OPTIONAL=[
  '/assets/dev-prism-frame-v662.webp?v=6.85',
  '/assets/organizer-silver-aura-v665.webp?v=6.85',
  '/manifest.webmanifest?v=6.85',
  '/icons/kokmatch-180.png?v=6.85',
...
self.addEventListener('install',event=>{event.waitUntil((async()=>{
 ...
 try{const shell=await fetch('/?km-sw-precache=6.85&t='+Date.now(),{cache:'reload'});if(shell&&shell.ok)await c.put(KOKMATCH_SHELL_KEY,shell.clone())}catch{}
