...
window.__kokmatchStandalone='6.29';
window.__kokmatchVersionLock='6.29';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.29')}catch{}
...
async function registerSw43(){if(!supported43())return null;if(swReg43)return swReg43;swReg43=await navigator.serviceWorker.register('/kokmatch-sw.js?v=6.29',{scope:'/',updateViaCache:'none'});await navigator.serviceWorker.ready;return swReg43}
...
async function activeSw44(force=false){
 ...
 const initial=await navigator.serviceWorker.register('/kokmatch-sw.js?v=6.29',{scope:'/',updateViaCache:'none'});
...
/* KokMatch v6.29 independent date + compact monthly statistics */
(()=>{
'use strict';
