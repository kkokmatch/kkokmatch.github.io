/* KokMatch v6.41 early resume guard: must run before legacy listeners. */
(()=>{
'use strict';
...
window.__kokmatchStandalone='6.41';
window.__kokmatchVersionLock='6.41';
window.__kokmatchLegacyAutoUpdateDisabled=true;
try{sessionStorage.setItem('kokmatch_runtime_version','6.41')}catch{}
...
const BUILD634=Object.freeze({version:'6.41',label:'콕매치 v6.41 · 최신 운영본'});
...
/* KokMatch v6.41: role-safe canonical member paging */
(()=>{
'use strict';
...
try{memberControls=controlsHtml637;window.memberControls=memberControls}catch(e){console.warn('KokMatch v6.41 memberControls source',e)}
...
try{
 ...
 window.renderMembers=renderMembers;
}catch(e){console.warn('KokMatch v6.41 renderMembers wrapper',e)}
try{
...
}catch(e){console.warn('KokMatch v6.41 member pager wrapper',e)}
function arm637(){
...
/* KokMatch v6.41: no-flash member roster resume */
(()=>{
'use strict';
