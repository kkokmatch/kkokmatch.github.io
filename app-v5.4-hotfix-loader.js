(()=>{
if(window.__kokmatchV54HotfixLoader10)return;
window.__kokmatchV54HotfixLoader10=true;
...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=4.1&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-fix6.js?v=6.4&t='+Date.now(),()=>add('/app-v5.4-fix7.js?v=7.0&t='+Date.now(),()=>add('/app-v5.4-fix8.js?v=8.0&t='+Date.now(),()=>add('/app-v5.4-fix9.js?v=9.1&t='+Date.now(),()=>add('/app-v5.4-fix10.js?v=10.0&t='+Date.now(),()=>add('/app-v5.4-fix11.js?v=11.0&t='+Date.now(),()=>add('/app-v5.4-fix12.js?v=12.0&t='+Date.now(),()=>add('/app-v5.4-fix13.js?v=13.0&t='+Date.now()))))))))))}
