(()=>{
if(window.__kokmatchV54HotfixLoader14)return;
window.__kokmatchV54HotfixLoader14=true;
...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=4.7&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-fix6.js?v=6.2&t='+Date.now(),()=>add('/app-v5.4-kakao-login-fix.js?v=1.0&t='+Date.now(),()=>add('/app-v5.4-fix21.js?v=21.0&t='+Date.now())))))}
