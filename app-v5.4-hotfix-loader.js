(()=>{
if(window.__kokmatchV54HotfixLoader22)return;
window.__kokmatchV54HotfixLoader22=true;
...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-kakao-login-fix.js?v=1.0&t='+Date.now(),()=>add('/app-v5.4-fix21.js?v=21.2&t='+Date.now(),()=>add('/app-v5.4-fix22.js?v=22.2&t='+Date.now(),()=>add('/app-v5.4-fix23.js?v=23.1&t='+Date.now(),()=>add('/app-v5.4-fix24.js?v=24.1&t='+Date.now(),()=>add('/app-v5.4-fix25.js?v=25.1&t='+Date.now(),()=>add('/app-v5.4-fix26.js?v=26.0&t='+Date.now())))))))))}
