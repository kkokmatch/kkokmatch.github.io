...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=4.1&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-fix6.js?v=6.4&t='+Date.now(),()=>add('/app-v5.4-fix7.js?v=7.0&t='+Date.now(),()=>add('/app-v5.4-fix8.js?v=8.0&t='+Date.now(),()=>add('/app-v5.4-fix9.js?v=9.1&t='+Date.now()))))))}
