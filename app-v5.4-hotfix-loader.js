(()=>{
if(window.__kokmatchV54HotfixLoader16)return;
window.__kokmatchV54HotfixLoader16=true;
...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=4.9&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-kakao-login-fix.js?v=1.0&t='+Date.now(),()=>add('/app-v5.4-fix21.js?v=21.2&t='+Date.now(),()=>add('/app-v5.4-fix22.js?v=22.0&t='+Date.now())))))}
