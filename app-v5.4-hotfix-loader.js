(()=>{
if(window.__kokmatchV54HotfixLoader17)return;
window.__kokmatchV54HotfixLoader17=true;
...
function loadFixes(){if(fixesStarted)return;fixesStarted=true;add('/app-v5.4-fix4.js?v=5.0&t='+Date.now(),()=>add('/app-v5.4-fix5.js?v=5.2&t='+Date.now(),()=>add('/app-v5.4-kakao-login-fix.js?v=1.0&t='+Date.now(),()=>add('/app-v5.4-fix21.js?v=21.2&t='+Date.now(),()=>add('/app-v5.4-fix22.js?v=22.2&t='+Date.now())))))}
