...
(()=>{if(window.__kokmatchV53Loader)return;window.__kokmatchV53Loader=true;const s=document.createElement('script');s.src='/app-v5.3.js?v=5.3&hotfix=3';s.async=false;s.onerror=()=>console.error('콕매치 v5.3 로드 실패');document.body.appendChild(s)})();